...
class AllOptionFunctions {
  ...
  static Widget buildAdditionalSection(BuildContext context) {
    return LayoutBuilder(
      builder: (context, constraints) {
        return OrientationBuilder(
          builder: (context, orientation) {
            final bool isPortrait = orientation == Orientation.portrait;
            final int crossAxisCount = isPortrait ? 4 : 6; // Ubah jumlah kolom berdasarkan orientasi

            return Column(
              children: [
                buildSettingItem(context, 'Telekomunikasi', {
                  'Pascabayar': 'assets/icon/handpone_icon.png',
                  'Pulsa/Data': 'assets/icon/paket_data_icon.png',
                }, crossAxisCount: crossAxisCount),
                buildSettingItem(context, 'Beli/Bayar Tagihan', {
                ...
                buildSettingItem(context, 'Transportasi', {
                ...
                buildSettingItem(context, 'Kartu Uang Elektronik', {
                  'Kartu Uang Elektronik': 'assets/icon/e-money_icon.png',
                }, crossAxisCount: crossAxisCount),
                buildSettingItem(context, 'Keuangan', {
                ...
                buildSettingItem(context, 'Travel dan Hiburan', {
                ...
                buildSettingItem(context, 'Dana Sosial', {
                ...
                buildSettingItem(context, 'Pajak', {
  ...
  static Widget buildSettingItem(BuildContext context, String title, Map<String, String> options,
    ...
    return ExpansionTile(
      ...
      children: [
        Padding(
          padding: const EdgeInsets.symmetric(horizontal: 16.0, vertical: 4.0), // Kurangi padding vertikal
                ...
                children: [
                  IconButton(
                    ...
                    onPressed: () {
                      ...
                      // Tambahkan logika untuk item lainnya jika perlu
                    },
                  ),
